 ...
 */
package com.pluralsight.kafka.avro.model;
...
public class Product extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  private static final long serialVersionUID = -3575000341344020938L;
  public static final org.apache.avro.Schema SCHEMA$ = new org.apache.avro.Schema.Parser().parse("{\"type\":\"record\",\"name\":\"Product\",\"namespace\":\"com.pluralsight.kafka.avro.model\",\"fields\":[{\"name\":\"Color\",\"type\":{\"type\":\"enum\",\"name\":\"Color\",\"symbols\":[\"GREEN\",\"BLUE\",\"PURPLE\"]}},{\"name\":\"ProductType\",\"type\":{\"type\":\"enum\",\"name\":\"ProductType\",\"symbols\":[\"TSHIRT\",\"DESIGN\"]}},{\"name\":\"DesignType\",\"type\":{\"type\":\"enum\",\"name\":\"DesignType\",\"symbols\":[\"NONE\",\"SUITCASE\",\"CAR\",\"WARNING\"]}}]}");
  ...
  @Deprecated public com.pluralsight.kafka.avro.model.Color Color;
  @Deprecated public com.pluralsight.kafka.avro.model.ProductType ProductType;
  @Deprecated public com.pluralsight.kafka.avro.model.DesignType DesignType;
   ...
   */
  public Product(com.pluralsight.kafka.avro.model.Color Color, com.pluralsight.kafka.avro.model.ProductType ProductType, com.pluralsight.kafka.avro.model.DesignType DesignType) {
    this.Color = Color;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: Color = (com.pluralsight.kafka.avro.model.Color)value$; break;
    case 1: ProductType = (com.pluralsight.kafka.avro.model.ProductType)value$; break;
    case 2: DesignType = (com.pluralsight.kafka.avro.model.DesignType)value$; break;
    default: throw new org.apache.avro.AvroRuntimeException("Bad index");
    }
  }
   ...
   */
  public com.pluralsight.kafka.avro.model.Color getColor() {
    return Color;
  }
   ...
   */
  public void setColor(com.pluralsight.kafka.avro.model.Color value) {
    this.Color = value;
  }
   ...
   */
  public com.pluralsight.kafka.avro.model.ProductType getProductType() {
    return ProductType;
  }
   ...
   * @param value the value to set.
   */
  public void setProductType(com.pluralsight.kafka.avro.model.ProductType value) {
   ...
   */
  public com.pluralsight.kafka.avro.model.DesignType getDesignType() {
    return DesignType;
  }
   ...
   * @param value the value to set.
   */
  public void setDesignType(com.pluralsight.kafka.avro.model.DesignType value) {
   ...
   */
  public static com.pluralsight.kafka.avro.model.Product.Builder newBuilder() {
    return new com.pluralsight.kafka.avro.model.Product.Builder();
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.pluralsight.kafka.avro.model.Product.Builder newBuilder(com.pluralsight.kafka.avro.model.Product.Builder other) {
    return new com.pluralsight.kafka.avro.model.Product.Builder(other);
  }
   ...
   * @return A new Product RecordBuilder
   */
  public static com.pluralsight.kafka.avro.model.Product.Builder newBuilder(com.pluralsight.kafka.avro.model.Product other) {
    return new com.pluralsight.kafka.avro.model.Product.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Product>
    ...
    private com.pluralsight.kafka.avro.model.Color Color;
    private com.pluralsight.kafka.avro.model.ProductType ProductType;
    private com.pluralsight.kafka.avro.model.DesignType DesignType;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(com.pluralsight.kafka.avro.model.Product.Builder other) {
      super(other);
     ...
     * @param other The existing instance to copy.
     */
    private Builder(com.pluralsight.kafka.avro.model.Product other) {
            super(SCHEMA$);
      if (isValidValue(fields()[0], other.Color)) {
        this.Color = data().deepCopy(fields()[0].schema(), other.Color);
        fieldSetFlags()[0] = true;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.kafka.avro.model.Product.Builder setColor(com.pluralsight.kafka.avro.model.Color value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.kafka.avro.model.Product.Builder clearColor() {
      Color = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.kafka.avro.model.Product.Builder setProductType(com.pluralsight.kafka.avro.model.ProductType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.kafka.avro.model.Product.Builder clearProductType() {
      ProductType = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.kafka.avro.model.Product.Builder setDesignType(com.pluralsight.kafka.avro.model.DesignType value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public com.pluralsight.kafka.avro.model.Product.Builder clearDesignType() {
      DesignType = null;
    ...
    public Product build() {
      try {
        ...
        record.Color = fieldSetFlags()[0] ? this.Color : (com.pluralsight.kafka.avro.model.Color) defaultValue(fields()[0]);
        record.ProductType = fieldSetFlags()[1] ? this.ProductType : (com.pluralsight.kafka.avro.model.ProductType) defaultValue(fields()[1]);
        record.DesignType = fieldSetFlags()[2] ? this.DesignType : (com.pluralsight.kafka.avro.model.DesignType) defaultValue(fields()[2]);
        return record;
